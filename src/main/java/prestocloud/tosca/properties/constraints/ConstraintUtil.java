package prestocloud.tosca.properties.constraints;
...
import org.prestocloud.tosca.normative.types.IComparablePropertyType;
...
import org.prestocloud.tosca.normative.types.StringType;
...
public final class ConstraintUtil {
    ...
    /**
     * Convert a string value following its type throw exceptions if it cannot be converted to a comparable
     * 
